<!-- doc-id: changelog -->
<!-- source-sha256: 1bd1f321150c9a0140786f36102edb8023e2e0699f55a8537c3ff9d38e84e064 -->
# 변경 기록
...
- JSON Lines처럼 공백으로 구분된 JSON 값 시퀀스를 위한 `ParseMany`와 `ParseManyWithMaxDepth`를 추가했습니다. 반환하는 각 값은 해당 문서를 따로 `Parse`한 결과와 같습니다.
